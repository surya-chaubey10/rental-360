...
$(function () {
    ...
    console.log(assetPath + "superadmin/user-json/user-list.json"); // JSON file to add data);
    // Users List datatable
    if (dtUserTable.length) {
        dtUserTable.DataTable({
            ajax: assetPath + "superadmin/user-json/user-list.json", // JSON file to add data
            columns: [
