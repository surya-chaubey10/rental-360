...
$(function () {
    ...
    $.ajaxSetup({
     ...
     newUserForm = $('.add-manage-booking-invoice');  //h
    ...
    $("#deliveryCharge").keyup(function () {
        ...
        var subTotal_amt =  $(".sub_total").val();
