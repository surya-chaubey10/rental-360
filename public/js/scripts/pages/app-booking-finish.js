...
$(function () {
  ...
  $.ajaxSetup({
   ...
   var dtUserTable = $('.booking-list-finish'),
    ...
    statusObj = {
      A: { title: 'Paid', class: 'badge-light-warning' },
      H: { title: 'Panding', class: 'badge-light-success' },
      P: { title: 'Panding', class: 'badge-light-secondary' }
    };
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
     // ajax: assetPath + "data/booking-data/" +1+ "_booking-data.json", // JSON file to add data
      ajax: assetPath + "data/booking-data/_booking-data.json",
      columns: [
