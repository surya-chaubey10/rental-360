...
$(function () {
  ...
  var dtUserTable = $('.coupons-list-table'),
  ...
  if ($('body').attr('data-framework') === 'laravel') {
    ...
    userView = assetPath + 'coupons-edit';
    offercopy = assetPath + 'coupons-copy';
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: assetPath + 'data/coupons-datatable.json',
      //add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          responsivePriority: 4,
          render: function (data, type, full, meta) {
            var $coupons_code = full['coupons_code'];
          
            return "<span class='text-truncate align-middle'>" + $coupons_code + '</span>';
          }
        },
        {
          // User Role
          ...
          render: function (data, type, full, meta) {
            ...
            return "<span class='text-truncate align-middle'>" + $start + '</span>';
          }
        },
        {
          targets: 3,
          render: function (data, type, full, meta) {
            ...
            return '<span class="text-nowrap">' + $end + '</span>';
          }
        },
		
		 {
          targets: 4,
          render: function (data, type, full, meta) {
            var $coupons_date = full['coupons_date']; 
        
            return '<span class="text-nowrap">' + coupons_date + '</span>';
          }
        },
