       ...
       // ajax: assetPath + "/data/offer/offer_packages-json/" + org_id + "_offer_package-list.json", // JSON file to 
        ...
        columnDefs: [
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              var $name = full['offer_category_id'];
          ...
          },
          {
            ...
            targets: 2,
            render: function (data, type, full, meta) {
              var $vehicle_id = full['vehicle_id'];
            
              return "<span class='text-truncate align-middle'>" + $vehicle_id + '</span>';
            }
          },
          {
            targets: 3,
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              ...
              return (
                ...
                '</button>'+'<button data-id="'+$uuid+'"  class="dropdown-item delete-record">' +
