...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
     // ajax: assetPath + "/data/offer/offer_packages-json/" + org_id + "_offer_package-list.json", // JSON file to 
      ajax: assetPath + "data/offer/offer_packages-json/" + org_id + "_offer_package-list.json", // JSON file to add data
      //add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          targets: 2,
          render: function (data, type, full, meta) {
            var $package_price = full['package_price'];
          
            return "<span class='text-truncate align-middle'>" + $package_price + '</span>';
          }
        },
        {
          targets: 3,
          render: function (data, type, full, meta) {
            var $days_limit = full['days_limit'];

            return '<span class="text-nowrap">' + $days_limit + '</span>';
          }
        },
        {
          targets: 4,
