...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: assetPath + 'data/payroll-datatable.json',
      //add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          responsivePriority: 4,
          render: function (data, type, full, meta) {
            var $emp_name = full['emp_name'];
          
            return "<span class='text-truncate align-middle'>" + $emp_name + '</span>';
          }
        },
        {
          // User Role
          targets: 2,
          render: function (data, type, full, meta) {
            var $emp_id = full['emp_id'];
          
            return "<span class='text-truncate align-middle'>" + $emp_id + '</span>';
          }
        },
        {
          targets: 3,
          render: function (data, type, full, meta) {
            ...
            return '<span class="text-nowrap">' + $designation + '</span>';
          }
        },
        {
          targets: 4,
          render: function (data, type, full, meta) {
            var salary_month = full['salary_month'];
        
            return '<span class="text-nowrap">' + salary_month + '</span>';
          }
        },
        {
          targets: 5,
        ...
        },
        {
          targets: 6,
          render: function (data, type, full, meta) {
            var account = full['account'];
        
            return '<span class="text-nowrap">' + account + '</span>';
          }
        },
        {
          targets: 7,
          render: function (data, type, full, meta) {
            var salary_date = full['salary_date'];
        
            return '<span class="text-nowrap">' + salary_date + '</span>';
          }
        },
        {
          // User Status
