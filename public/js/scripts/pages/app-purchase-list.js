...
$(function () {
    ...
    if (dtUserTable.length) {
      dtUserTable.DataTable({
         ajax: assetPath + 'data/purchase-datatable.json',
        //add data
        columns: [
        ...
        columnDefs: [
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              ...
              return "<span class='text-truncate align-middle'>" + $supplier + '</span>';
            }
          },
          {
            targets: 4,
          ...
          },
          {
            targets: 6,
            render: function (data, type, full, meta) {
              var charges = full['charges'];
          
              return '<span class="text-nowrap">' + charges + '</span>';
            }
          },
          {
            targets: 7,
