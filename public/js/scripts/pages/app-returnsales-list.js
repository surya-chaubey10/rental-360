...
$(function () {
    ...
    if (dtUserTable.length) {
      dtUserTable.DataTable({
        ajax: assetPath + 'data/returnsales-datatable.json',
        //add data
        columns: [
        ...
        columnDefs: [
          ...
          },
          {
            ...
            responsivePriority: 4,
            render: function (data, type, full, meta) {
              var $return_no = full['return_no'];
            
              return "<span class='text-truncate align-middle'>" + $return_no + '</span>';
            }
          },
          {
            // User Role
            targets: 2,
            render: function (data, type, full, meta) {
              var $puchase_no = full['puchase_no'];
            
              return "<span class='text-truncate align-middle'>" + $puchase_no + '</span>';
            }
          },
          {
            targets: 3,
            render: function (data, type, full, meta) {
              var $supplier = full['supplier'];
  
              return '<span class="text-nowrap">' + $supplier + '</span>';
            }
          },
          {
            targets: 4,
            render: function (data, type, full, meta) {
              var return_reason = full['return_reason'];
          
              return '<span class="text-nowrap">' + return_reason + '</span>';
            }
          },
          {
            targets: 5,
            render: function (data, type, full, meta) {
              var product_cost = full['product_cost'];
          
              return '<span class="text-nowrap">' + product_cost + '</span>';
            }
          },
          {
            targets: 6,
