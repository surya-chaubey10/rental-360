 ...
 */
 ...
 $(function () {
  ...
  var dt_basic_table = $('.balance-adjustment-list'),
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ajax: assetPath + 'data/balance-adjustment-datatable.json',
      columns: [
      ...
      columnDefs: [
          ...
          render: function (data, type, full, meta) {
            return (
              '<div class="d-inline-flex">' +
               '<a href="balance-adjustment-add" style="background-color: #0000ff14" >Add Balance</a>'+
              '</div>'   
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              '<div class="d-inline-flex">' +
               '<a href="balance-adjustment-edit">' +
