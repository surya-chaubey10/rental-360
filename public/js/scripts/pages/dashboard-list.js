...
$(function () {
  ...
  var dtUserTable = $('.top-merchant-table'), 
  ...
  if (dtUserTable.length) {
    ...
    dtUserTable.DataTable({
      ajax: assetPath + "data/dashboard-company-json/dashboard-company-list.json",
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return '<span class="text-nowrap">' + $payment + '</span>';
          }
        },
         {
          targets: 4,
          render: function (data, type, full, meta) {
            var $email = full['payment'];
