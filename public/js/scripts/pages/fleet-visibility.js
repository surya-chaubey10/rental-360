...
$(function () {
  ...
  if (dtInvoiceTable.length) {
    var dtInvoice = dtInvoiceTable.DataTable({
      ajax: assetPath + 'data/fleet.json', // JSON file to add data
      autoWidth: false,
      columns: [
      ...
      columnDefs: [
       ...
       
        {
          ...
          render: function (data, type, full, meta) {
            var $total = full['market_inventry'];
