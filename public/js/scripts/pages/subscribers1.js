...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: assetPath + 'data/subscribers.json', // JSON file to add data
      //add data
      columns: [
       ...
       
        {
          ...
          render: function (data, type, full, meta) {
            ...
            if ($image) {
              // For Avatar image
              var $output =
                '<img  src="'+'images/avatars/' + $image + '" alt="Avatar" width="32" height="32">';
            } else {
              // For Avatar badge
            ...
            var $rowOutput =
              ...
              statusObj[$email].class +
              '" text-capitalized>' +
              statusObj[$email].title +
              '</span>'
            return $rowOutput;
          }
        },
