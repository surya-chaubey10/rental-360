...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: assetPath + "/data/superadmin-role/superadmin-role-data.json", // JSON file to add data
        ...
        },
         {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              '<a href="update-superadmin-role/'+$id +
              '" class="dropdown-item">' +
...
if (newUserForm.length) {
  ...
  newUserForm.on('submit', function (e) {
    if (!e.isDefaultPrevented()) {
       ...
       $.ajax({
              url: 'save_superadminrole', // JSON file to add data,
              type: 'POST',
              dataType: 'json',
              data: formData,
              contentType: false,
  ...
  function deleteRecord(value_id) {
    $.ajax({
      url: 'superadmin-role-delete'+'/'+value_id, // JSON file to add data,
      type: 'get',
      dataType: 'json',
      contentType: false,
      processData: false,
...
$(document).ready(function(){
  ...
  $.ajax({
  type: 'GET',
  url: 'superadmin-role-toggle/'+thisRef.attr('id'),
