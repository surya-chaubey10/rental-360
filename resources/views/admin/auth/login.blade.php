...
<div class="auth-wrapper auth-cover">
  <div class="auth-inner row m-0">
   ...
   <img src="/public/images/logo/logo5.svg">
        <defs>
    ...
    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
      <div class="w-100 d-lg-flex align-items-center justify-content-center">
          ...
          <img class="img-fluid login-screen-admin" src="{{asset('images/logo/login12.png')}}" alt="Login V2" />
    ...
    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
      <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        <h2 class="card-title fw-bold mb-1">Welcome to Rental 360! 👋</h2>
        ...
        <form class="auth-login-form mt-2 myForm" method="POST" action="{{ route('admin.login') }}">
                            ...
                            <div class="input-group input-group-merge form-password-toggle">
                                <input id="password" type="password"
                                    ...
                                    <span class="input-group-text togglePassword" id="">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye-off" style="cursor: pointer"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                                          </span>
                        ...
                        <button class="btn btn-danger w-100" type="submit" tabindex="4">Login</button>
                    </form>
