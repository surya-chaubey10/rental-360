        ...
        <div class="card-body invoice-padding ">
          <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
            <div class="col-md-6">
              ...
              <p class="card-text mb-0" style="margin-left:5%">{{isset($get_data->org_street1)? $get_data->org_street1:''}}, {{isset($get_data->org_street2)? $get_data->org_street2:''}}</p>
              <p class="card-text mb-0"style="margin-left:5%">{{isset($get_data->org_city)? $get_data->org_city:''}}, {{isset($get_data->org_state)? $get_data->org_state:''}}, {{isset($get_data->org_postal)? $get_data->org_postal:''}}</p>
              <p class="card-text mb-0"style="margin-left:5%">{{isset($get_data->org_phone)? $get_data->org_phone : ''}}, {{isset($get_data->org_contact_person_number) ? $get_data->org_contact_person_number : ''}}</p>
            </div>
            <div class="invoice-number-date mt-md-0 mt-2 col-md-6">
              ...
              <div class="d-flex align-items-center justify-content-md-end mb-1">
                ...
                <input type="text" class="form-control invoice-edit-input" value="{{$get_data->date}}" readonly/>
              </div>
          ...
          <div class="row">
            <div class="col-12"> 
              <div class="mb-2">
                ...
                >
                <input type="hidden" class="form-control"  id="booking_id" name="booking_id" value="{{$get_data->booking_id}}"> @csrf
              </div>
            </div>
          </div>                   
        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 order-1 order-md-0"> 
                          ...
                          <form class="add-manage-booking modal-content pt-0 form-block invoice-repeater" autocomplete="off" id="booking_form" method="">
                            ...
                            <div class="modal-header">
                                ...
                                <a href="javascript:;" class="btn btn-danger mb-1 waves-effect" style="float: right;" > <i data-feather='x'></i></a>
                                @else
                                <a href="{{route('booking-list')}}" class="btn btn-danger mb-1 waves-effect" style="float: right;" > <i data-feather='x'></i></a>
                                @endif  
                            </div> 
                            <hr> 
                            ...
                            <section id="multiple-column-form">
                              <div class="modal-body">
                                  ...
                                  <p>
                                  <a href="{{isset($get_data->short_link)? $get_data->short_link:''}}" target="_blank" style="color: red;" rel="nofollow" id="copy" >{{isset($get_data->short_link)? $get_data->short_link:''}} </a> 
                                </p>
                                <input type="hidden" value="{{isset($get_data->short_link)? $get_data->short_link:''}}" id="copied_url">
                              </div> 
                              ...
                              <div class="card-body">  
                                <div class="icon-wrapper"  height= 40px; width= 60px; >  
                                  ...
                                  <a title="WhatsApp" href="https://api.whatsapp.com/send?phone={{isset($get_data->mobile)? $get_data->mobile:''}}&text={{isset($get_data->short_link)? $get_data->short_link:''}}" class="btn btn-danger waves-effect">  <i data-feather='message-circle'></i></a>
                                  ...
                                  <button title="Message" class="btn btn-danger waves-effect"> <i data-feather='message-square'></i></button>
...
@section('page-script') 
<script src="{{asset('js/scripts/pages/app-invoices.js')}}"></script>
@endsection
