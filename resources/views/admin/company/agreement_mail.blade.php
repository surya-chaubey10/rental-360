	...
	<body>
		<div style="width: 600px; margin:0px auto">
			...
			<div style="font-size:14px; line-height:30px; padding:5px 5px; border-top:1px solid transparent;border:1px solid #ddd;">
                ...
                Dear {{ucfirst($data->adminUser->fullname)}}
			    </p>
                <p>
                Please click <a href="http://159.223.107.48/mail-aggrement/{{$data->uuid}}" ><b>here</b></a>, to complete approval process. <br>Our 
				<a href="http://159.223.107.48/public/agreement/merchant-services-agreement.pdf" download="merchant-services-agreement.pdf"> term &amp; conditions.</a><br>
                </p> 
                <p>
                Regards,<br>
				Team Rental 360
