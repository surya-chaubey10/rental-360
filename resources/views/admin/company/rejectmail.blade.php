	...
	<body>
		<div style="width: 600px; margin:0px auto">
            ...
            <img src="{{ asset('images/portrait/small/logo.png') }}" alt="avatar" style="width:80px">
			 <span style="float:right;font-weight:bolder;display:block;font-size:20px; color:white  !important;" id="company_name_header">Document Rejected</span>
		   </p>
            ...
            <p>{{$data['msg']}} <span style="color:red">{{$data['resean']}}</span>{{$data['dot']}}</p> 
            <p> </p> 
			<p>  Regards,<br>
				Team Rental 360</p>
				</div>
