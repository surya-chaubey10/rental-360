...
<section class="app-user-view-account">
                <div class="row">
                  <div class="card" style="height:520px;"> 
                    <div class="card-body"> 
                      <div class="card-header">
                        <h4  style="font-size: 1.750rem;"><b>Inventory</b></h4>
                        <button class="btn btn-danger add_button" id="my-input-id" disabled="disabled">{{ request()->route('uuid') ? 'Update Inventry' : 'Create Inventory' }}</button>
                      </div>
                      <hr>
                                  ...
                                  <div class="card-body">
                                    <div class="row">  
                                      ...
                                      <div class="col-md-1 col-6">
                                        <div class="mb-1">
                                        <button type="button" class="btn btn-primary" style="margin-top:48%" data-bs-toggle="modal" data-bs-target="#modals-slide-in">
                                      ...
                                      <div class="col-md-1 col-6 addmodel12" style="display:none" >
                                        <div class="mb-1">
                                        <button type="button" class="btn btn-primary" style="margin-top:48%" data-bs-toggle="modal" data-bs-target="#modals-addslide">
                                        <i data-feather='plus-circle'></i>
                                        </button>
                                        </div>
                                      </div> 
                  ...
                  <div class="modal new-user-modal fade" id="modals-slide-in" style="margin-top:4%;">
                  ...
                  <!-- Modal to add new model starts-->
                      <div class="modal  new-model-modal fade" id="modals-addslide" style="margin-top:4%;">
                        <div class="modal-dialog">
...
@section('page-script')
  {{-- Page js files --}}
 <script src="{{ asset('js/scripts/pages/app-store-inventry-list.js') }}"></script> 
