<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item me-auto">
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <h2 class="brand-text">Rent 365</h2>
                </a>
            </li>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <ul class="menu-content">
                    <li>
                        <a href="#" class="d-flex align-items-center" target="_self">
                            ...
                            <span class="menu-item text-truncate">Summary</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="d-flex align-items-center" target="_self">
            ...
            <li class="nav-item">
                <a href="{{ route('') }}" class="d-flex align-items-center" target="_self">
            ...
            <li class="nav-item has-sub" style="">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Market</span>
                </a>
                <ul class="menu-content">
                    <li>
                        <a href="#" class="d-flex align-items-center" target="_self">
                            <i data-feather='circle'></i>
                            <span class="menu-item text-truncate">Vendor Visibility</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="d-flex align-items-center" target="_self">
                            <i data-feather='circle'></i>
                            <span class="menu-item text-truncate">Fleet Visibility</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="d-flex align-items-center" target="_self">
            ...
            <li class="nav-item">
                <a href="#" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Backups</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="#" class="d-flex align-items-center" target="_self">
                    <i data-feather='file-text'></i>
                    <span class="menu-title text-truncate">Audit</span>
                </a>
            </li>
            <li class="nav-item has-sub" style="">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                ...
                <ul class="menu-content">
                    <li>
                        <a href="#" class="d-flex align-items-center" target="_self">
                            <i data-feather='circle'></i>
                            <span class="menu-item text-truncate">General</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="d-flex align-items-center" target="_self">
                            <i data-feather='circle'></i>
                            <span class="menu-item text-truncate">Localization</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="d-flex align-items-center" target="_self">
                    ...
                    <li>
                        <a href="#" class="d-flex align-items-center" target="_self">
                            <i data-feather='circle'></i>
                            <span class="menu-item text-truncate">Cron Jobs</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="d-flex align-items-center" target="_self">
                            <i data-feather='circle'></i>
                            <span class="menu-item text-truncate">Misc</span>
                        </a>
                    </li>
                </ul>
            </li>
