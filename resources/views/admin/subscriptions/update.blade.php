                    ...
                    <div class="col-md-4">
                      <div class="mb-1">
                        ...
                        <input class="form-control" type="text" id="convenience_fees_amount"
                          value="{{ $SubscriptionPlans->convenience_fees_amount}}" {{ ($SubscriptionPlans->convenience_fees_type=="1") ?
                              "readonly" : "" }} name="convenience_fees_amount"
                          placeholder="%">
                      </div>
                    </div>
                </div>
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="mb-1">
                        ...
                        <input class="form-control" type="text" id="commission_fees_amount" {{ ($SubscriptionPlans->convenience_fees_type=="2") ?
                              "readonly" : "" }}  value="{{ $SubscriptionPlans->commission_fees_amount}}" name="commission_fees_amount" placeholder="%">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="mb-1">
                        ...
                        <input class="form-control" type="text" id="withdrawal_charges_amuont" {{ ($SubscriptionPlans->convenience_fees_type=="3") ? "readonly" : "" }}  value="{{ $SubscriptionPlans->withdrawal_charges_amuont}}" name="withdrawal_charges_amuont" placeholder="%">
                      </div>
                    </div>
                  </div>
                </section>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 col-6">
                            ...
                            <div class="mb-1  mt-2">
                              <input class="form-check-input ml-1 payment_gateway_charge" type="checkbox" data-id="1"
                                name="payment_gateway_charge[]" id="payment_gateway_charge1" value="1" {{in_array('1',$payment_gateway) ? 'checked' : '' }}/>
                          ...
                          <div class="col-md-4 col-4 mb-1">
                            <input class="form-control ml-1 pga1" type="number" name="payement_gateway_amount[]"
                              id="payement_gateway_amount"  placeholder="%" value="{{ $SubscriptionPlans->commission_fees_amount}}" />
                          </div>
                        </div> <!-- row end -->
                      </div><!-- col-8 end -->
                      <div class="col-8">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 col-6">
                            <div class="mb-1  mt-2">
                              <input class="form-check-input ml-1 payment_gateway_charge" type="checkbox" data-id="2"
                                name="payment_gateway_charge[]" id="payment_gateway_charge2" value="2" {{in_array('2',$payment_gateway) ? 'checked' : '' }}/>
                          ...
                          <div class="col-md-4 col-4 mb-1">
                            <input class="form-control ml-1 pga2" type="number" name="payement_gateway_amount[]"
                              id="payement_gateway_amount" {{in_array('2',$payment_gateway) ? '' : 'readonly' }} placeholder="%" value="{{ $SubscriptionPlans->commission_fees_amount}}" />
                          </div>
                        </div> <!-- row end -->
                      </div><!-- col-8 end -->
                      <div class="col-8">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 col-6">
                            ...
                            <div class="mb-1  mt-2">
                              <input class="form-check-input ml-1 payment_gateway_charge" type="checkbox" data-id="3"
                                name="payment_gateway_charge[]" id="payment_gateway_charge3" value="3" {{in_array('3',$payment_gateway) ? 'checked' : '' }}/>
                          ...
                          <div class="col-md-4 col-4 mb-1">
                            ...
                            <input class="form-control ml-1 pga3" type="number" name="payement_gateway_amount[]"
                              id="payement_gateway_amount" {{in_array('3',$payment_gateway) ? '' : 'readonly' }} placeholder="%" value="{{ $SubscriptionPlans->commission_fees_amount}}" />
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 col-6">
                            <div class="mb-1 mt-2 ">
                              <input class="form-check-input ml-1 payment_gateway_charge" type="checkbox" data-id="4"
                                name="payment_gateway_charge[]" id="payment_gateway_charge4" value="4" {{in_array('4',$payment_gateway) ? 'checked' : '' }} />
                          ...
                          <div class="col-md-4 col-4 mb-1">
                            <input class="form-control ml-1 pga4" type="number" name="payement_gateway_amount[]"
                              id="payement_gateway_amount" {{in_array('4',$payment_gateway) ? '' : 'readonly' }} placeholder="%" value="{{ $SubscriptionPlans->commission_fees_amount}}" />
                          </div>
                        </div> <!-- row end -->
                      </div><!-- col-8 end -->
                      <div class="col-8">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 col-6">
                            <div class="mb-1  mt-2">
                              <input class="form-check-input ml-1 payment_gateway_charge" type="checkbox" data-id="5"
                                name="payment_gateway_charge[]" id="payment_gateway_charge5" value="5" {{in_array('5',$payment_gateway) ? 'checked' : '' }} />
                          ...
                          <div class="col-md-4 col-4 mb-1">
                            <input class="form-control ml-1 pga5" type="number" name="payement_gateway_amount[]"
                              id="payement_gateway_amount" {{in_array('5',$payment_gateway) ? '' : 'readonly' }} placeholder="%" value="{{ $SubscriptionPlans->commission_fees_amount}}" />
                          </div>
                        </div> <!-- row end -->
                      </div><!-- col-8 end -->
                  ...
                  <div class="table-responsive">
                    <table class="table mb-2">
                      ...
                      <tbody>
                        ...
                        {{--  @foreach($Subscriptionmenus as $key => $menu)
                        <tr>
                            <td>
                            ...
                            <td>
                            @foreach($menu->subcription_sub_menu as $sub_menu)
                            <div class="d-flex align-items-center">
                                <div class="form-check-inline">
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="checked"
                                  checked />
                                <label class="form-check-label" for="inlineCheckbox1">Submodule 1</label>
                              </div>
                            </div>
                            <div class="d-flex align-items-center">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="checked"
                                  checked />
                                <label class="form-check-label" for="inlineCheckbox1">Submodule 2</label>
                              </div>
                            </div>
                            <div class="d-flex align-items-center">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="checked" />
                                <label class="form-check-label" for="inlineCheckbox1">Submodule 3</label>
                              </div>
                            </div>
                            <div class="d-flex align-items-center">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="checked"
                                  checked />
                                <label class="form-check-label" for="inlineCheckbox1">Submodule 4</label>
                              </div>
                            </div>
                          </td>
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="checked"
                                  checked />
                                <label class="form-check-label" for="inlineCheckbox1">Booking</label>
                              </div>
                            </div>
                          </td>
                          <td>
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="checked"
                                  checked />
                                <label class="form-check-label" for="inlineCheckbox1">Account</label>
                              </div>
                            </div>
                          </td>
                          <td>
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="checked"
                                  checked />
                                <label class="form-check-label" for="inlineCheckbox1">Operation</label>
                              </div>
                            </div>
                          </td>
                          <td>
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="checked"
                                  checked />
                                <label class="form-check-label" for="inlineCheckbox1">Terms</label>
                              </div>
                            </div>
                          </td>
                          <td>
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="checked"
                                  checked />
                                <label class="form-check-label" for="inlineCheckbox1">Backup</label>
                              </div>
                            </div>
                          </td>
                          <td>
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="checked"
                                  checked />
                                <label class="form-check-label" for="inlineCheckbox1">Audit</label>
                              </div>
                            </div>
                          </td>
                          <td>
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="checked"
                                  checked />
                                <label class="form-check-label" for="inlineCheckbox1">Setting</label>
                              </div>
                            </div>
                          </td>
                          <td>
