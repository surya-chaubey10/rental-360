    ...
    <div class="col-xl-12 col-lg-5 col-md-5 order-1 order-md-0">
      ...
      <div class="card"> 
        ...
        <div class="card-header">
                  <h4 style="font-size: 1.486rem;">Create Accounts</h4>
                  <a href="{{route('account-list')}}" class="btn btn-xs btn-danger" style="float: right; margin-top: -45px;" >Submit</a>
                </div><hr> 
                          ...
                          <div class="card"> 
                            <div class="card-body">
                                ...
                                <div class="mb-1">
                                      ...
                                      <input type="text" id="transfer" class="form-control" value="" placeholder="" name="pickup_date_time" /> 
                                    </div>
                                    </div>
