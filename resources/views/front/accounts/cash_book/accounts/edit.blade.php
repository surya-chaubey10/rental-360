    ...
    <div class="col-xl-12 col-lg-5 col-md-5 order-1 order-md-0">
      ...
      <div class="card"> 
        ...
        <div class="card-header">
                  <h4 style="font-size: 1.486rem;">Edit Accounts</h4>
                  <a href="{{route('account-list')}}" class="btn btn-xs btn-danger" style="float: right; margin-top: -45px;" >Save</a>
                </div><hr> 
                        ...
                        <div class="col-12">
                          <div class="card"> 
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                <div class="mb-1">
                                      <label class="form-label" for="pickup_date_time-column">Bank Name*</label>
                                      <input type="text" id="transfer" class="form-control" value="" placeholder="Cash" name="pickup_date_time" /> 
                                    </div>
                                    </div>
                                    
                                  <div class="col-md-6">
                                    <div class="mb-1">
                                      <label class="form-label" for="select_vehicle-column">Branch Name</label>
                                      <div class="mb-1">
                                      <input type="text" id="transfer" class="form-control" value="" placeholder="Office" name="pickup_date_time" />
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-6">
                                    <div class="mb-1">
                                      <label class="form-label" for="select_vehicle-column">Account Number*</label>
                                      <div class="mb-1">
