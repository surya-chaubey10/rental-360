                    ...
                    <table class=" table"> 
                        ...
                        <tr>
                         ...
                         <td>{{date("d/M/Y",strtotime($gl_data->created_at))}}</td> 
                          ...
                          @if($gl_data->acounts_payment_id!=NULL && $gl_data->inv_id==NULL)

                            @if($gl_data->tran_type=="Cash")
                            <td><a class="fw-bold" data-id="{{($gl_data->transaction_id)}}" id="statement_details" data-bs-toggle="modal" data-bs-target="#myModel_cash" style="color:red;"> {{($gl_data->trans_ref)}}</a></td>
                            @else
                            <td><a class="fw-bold" data-id="{{($gl_data->transaction_id)}}" id="statement_details" data-bs-toggle="modal" data-bs-target="#myModel" style="color:red;"> {{($gl_data->trans_ref)}}</a></td>
                            @endif

                          @elseif($gl_data->acounts_payment_id!=NULL && $gl_data->inv_id!=NULL)

                          @if($gl_data->tran_type=="Cash")
                            <td><a class="fw-bold" data-id="{{($gl_data->transaction_id)}}" id="statement_details" data-bs-toggle="modal" data-bs-target="#detais_cash" style="color:red;"> {{($gl_data->trans_ref)}}</a></td>
                            @else
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6 col-12">
                                <div class="mb-1  col-md-12 col-12">
                                  ...
                                  <input type=tel maxlength="14" oninput="this.value=this.value.replace(/[^0-9]/g,'');" id="phone" class="form-control" value=""  name="phone" /> 
  ...
  <div class="col-xl-12 col-lg-5 col-md-5 order-1 order-md-0">    
    <div class="card"> 
      <!-- <div class="card-body">  -->  
         ...
         <div class="modal fade show " id="detais_cash" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true" style="padding-right: 5px;" >
   <div class="modal-dialog modal-xl" role="document">
     <div class="modal-content" style="width:90%; margin-left:5%">  
          <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">
                <label for="" id="status_label9" class="label label-lg bg-light-success label-inline"> </label>
                 <span id="transaction_type9"> </span> <span id="transaction_referance9"> </span>
              </h5>
          ...
          <div class="modal-body">
              <ul class="list-group" style="border-radius: 0px">
                  <li class="list-group-item active" style="font-size: 15px; font-weight:bold">#<span id="transaction_id9"></span> : Rental 360</li>
              </ul>
              <div class="row">
                  <div class="col-md-8 col-lg-8">
                      <ul class="list-group" style="border-radius: 0px">
                          <li class="list-group-item">
                              <div class="row">
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Amount</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="cart_amount_currency9"> </span></div>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Date:</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_date9"> </span></div>
                                      </div>
                                  </div>
                              </div>
                          </li>
                          <li class="list-group-item" id="customer_inovice_li">
                              <div class="row">
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Status</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_status9"> </span></div>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row" id="invoice_li">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Invoice #</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_invoice_no9"> </span></div>
                                      </div>
                                  </div>
                              </div>
                          </li>
                          <li class="list-group-item">
                              <div class="row">
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Description</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_description9"></span></div>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row" id="invoice_li">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for=""> </strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id=" "> </span></div>
                                      </div>
                                  </div>
                              </div>
                          </li>
                      ...
                      <div class="col-md-4 col-lg-4 align-items-center text-center mt-2">
                      <h3 class="mt-0 mb-1"><b>Bill To</b></h3>
                      <p id="name9" class="m-0"> </p>
                      <p id="c_email9" class="m-0"> </p>
                      <p id="address9" class="m-0 pac-target-input" placeholder="Enter a location" autocomplete="off"></p>
                      <p id="c_country9" class="m-0"> </p> 
                      <p id="c_state9" class="m-0"> </p>
                      <br>
                      <p id="refund_p" class=""><b>Refund:</b>
                            <button class="btn btn-danger btn-sm" id="refund_btn"> <i data-feather='minus-square'></i>
                            <input type="hidden" id="hidden_cart_id">
                      ...
                      <div class="row" id="list_to_hide">
                          ...
                          <ul class="list-group-custom " style="border-radius: 0px; margin: 21px 0 0 0;">
                                <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Sub Total</strong></div>
                                    <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="sub_total9"> </span></div>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Discount</strong></div>
                                        <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="discount9"> </span></div>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Delivery Charges</strong></div>
                                        <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="shipping_charges9">  </span></div>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Grand Total</strong></div>
                                        <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="grand_totalsss9"> </span></div>
                                    </div>
                                </li>
                              </ul>
                        </div>
    ...
    <div class="row">  
     <div class="col-xl-12 col-lg-5 col-md-5 order-1 order-md-0">    
      <div class="card"> 
         ...
         <div class="modal fade show " id="myModel" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true" style="padding-right: 5px;" >
          <div class="modal-dialog modal-xl" role="document">
           <div class="modal-content" style="width: 70%; margin-left: 16%;">  
          <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">
              <label for="" id="transaction_type1" class="label label-lg bg-light-success label-inline"> </label>
                 <span id="transaction_type1"> </span> <span id="transaction_referance1"> </span>
              </h5>
          ...
          <div class="modal-body">
              ...
              <div class="row">
                  <div class="col-md-8 col-lg-8">
                      ...
                      <li class="list-group-item">
                              <div class="row">
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Amount</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="cart_amount_currency1"> </span></div>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Cart Id</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_cart_id1"></span></div>
                                      </div>
                                  </div>
                              </div>
                          </li>
                          <li class="list-group-item" id="customer_inovice_li">
                              <div class="row">
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Status</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_status1"> </span></div>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Response Code</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_resp_msg1"> </span></div>
                                      </div>
                                  </div>
                              </div>
                          </li>
                          <li class="list-group-item">
                              <div class="row">
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Date:</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_date1"> </span></div>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row" id="invoice_li">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Invoice #</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_invoice_no1"> </span></div>
                                      </div>
                                  </div>
                              </div>
                          </li>
                          <li class="list-group-item " id="invoice_ref_li">
                              <div class="row">
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Invoice Ref</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_invoice_ref1"> </span></div>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Customer Ref</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_customer_ref1"></span></div>
                                      </div>
                                  </div>
                              </div>
                          </li>
                          <li class="list-group-item">
                              <div class="row">
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Description</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_description1"></span></div>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Card Scheme</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="card_scheme1"></span></div>
                                      </div>
                                  </div>
                              </div>
                          </li>
                          <li class="list-group-item">
                              <div class="row">
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Payment Description</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="payment_description1" style="font-size: 10px;"> </span></div>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Card Type</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="card_type1"> </span></div>
                                      </div>
                                  </div>
                              </div>
                          </li>
                          <li class="list-group-item">
                              <div class="row">
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Expiry Month</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="expiryMonth1"> </span></div>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Expiry Year</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="expiryYear1"> </span></div>
                                      </div>
                                  </div>
                              </div>
                          </li>
                      ...
                      <h3 class="mt-5 mb-1"><b>Bill To</b></h3>
                      <p id="name12" class="m-0"> </p>
                      <p id="c_email1" class="m-0"> </p>
                      <p id="phone2" class="m-0 pac-target-input" placeholder="Enter a location" autocomplete="off"></p>
                      <p id="c_country1" class="m-0"> </p> 
                      <p id="c_state1" class="m-0"> </p>
                      <br>                                       
                     </div>  
                     </div> 
          </div>
    ...
    <div class="row">  
     <div class="col-xl-12 col-lg-5 col-md-5 order-1 order-md-0">    
      <div class="card"> 
         ...
         <div class="modal fade show " id="myModel_cash" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true" style="padding-right: 5px;" >
          <div class="modal-dialog modal-xl" role="document">
           <div class="modal-content" style="    width: 70%; margin-left: 16%;">  
          <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">
              <label for="" id="transaction_type123" class="label label-lg bg-light-success label-inline"> </label>
                 <span id="transaction_type123"> </span> <span id="transaction_referance123"> </span>
              </h5>
          ...
          <div class="modal-body">
              <ul class="list-group" style="border-radius: 0px">
                  <li class="list-group-item active" style="font-size: 15px; font-weight:bold">#<span id="transaction_id123"></span> : Rental 360</li>
              </ul>
              <div class="row">
                  <div class="col-md-8 col-lg-8">
                      <ul class="list-group" style="border-radius: 0px">
                          <li class="list-group-item">
                              <div class="row">
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Amount</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="cart_amount_currency123"> </span></div>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                      <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Date:</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_date123"> </span></div>
                                      </div>
                                  </div>
                              </div>
                          </li>
                          <li class="list-group-item" id="customer_inovice_li">
                              <div class="row">
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for="">Status</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_status123"> </span></div>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-lg-6">
                                      <div class="row">
                                          <div class="col-md-6 col-lg-6 col-sm-6"><strong for=""> Description</strong></div>
                                          <div class="col-md-6 col-lg-6 col-sm-6"><span for="" id="transaction_description123"> </span></div>
                                      </div>
                                  </div>
                              </div>
                          </li>
                      ...
                      <div class="col-md-4 col-lg-4">
                      <h3 class="mt-2 mb-1"><b>Bill To</b></h3>
                      <p id="name1234" class="m-0"> </p>
                      <p id="c_email123" class="m-0"> </p>
                      <p id="phone234" class="m-0 pac-target-input" placeholder="Enter a location" autocomplete="off"></p>
                      <p id="c_country123" class="m-0"> </p> 
                      <p id="c_state123" class="m-0"> </p>
                      <br>                                       
                     </div>
                     </div> 
          </div>
