...
<span class="me-1"><span class="dot dot1"></span>  Reserve </span>     
<span class="me-1"><span class="dot dot2"></span>  Invoice </span>
<span><span class="dot dot3"></span>  Booking confirm </span>
</div>
                            ...
                            <div class="col-12"><!--col-8-start--> 
                              ...
                              <div class="row">
                                ...
                                <div class="form-group col-md-6 smsForm">
                                  ...
                                  <input type="tel" class="form-control" name="phone" id="phone" placeholder="" pattern="[7-9]{1}[0-9]{9}" required />
                                ...
                                <div class="row mb-2 " id="merchant" style="display:none"> 
                                    ...
                                    <div class="col-xl-6 col-md-6 col-6" >
                                        <div class="mb-1">
                                            ...
                                            <span class="form-text text-danger" id="merchantName_error"></span>
                                    ...
                                    <!-- <div class="col-xl-6 col-md-6 col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="tel" class="form-control" name="merchantPhone" id="merchantPhone" placeholder="Phone">
                                            <span class="form-text text-danger" id="merchantPhone_error"></span>

                                          </div>
                                    </div>  -->

                                    <div class="form-group col-md-6 merchantPhoneno">
                                      <label for="contact2"> Phone merchantPhoneno </label>
                                      <input type="text" class="form-control" name="merchantPhone" id="merchantPhone" placeholder="Type contact2 number here...." pattern="[7-9]{1}[0-9]{9}" required />
                                      <div class="valid-feedback">Valid.</div>
                                      <div class="invalid-feedback">Please enter valid contact no.</div>
                                    </div> 
<!-- 
                                    <div class="col-xl-6 col-md-6 col-6">
                                      <div class="mb-1">
                                          ...
                                          <span class="form-text text-danger" id="merchant_sku_error"></span>
                                ...
                                <div class="row mb-2 " id="auto_dispached"> 
                                  ...
                                  <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                      <label class="form-label" for="select_model" style="margin-left:24px;">Model</label>
                                      <div class="mb-1"  style="width: 101%;margin-left: 20px;">
            ...
            <div class="card-body">  
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6 whatsappForm">
                  ...
                  <input type="text" class="form-control" name="phone" id="phones" placeholder="Type contact2 number here...." pattern="[7-9]{1}[0-9]{9}" required />
                  <div class="valid-feedback">Valid.</div>
                  <div class="invalid-feedback">Please enter valid contact no.</div>
                </div> 
  ...
  <div class="d-flex row">
    ...
    <div class="col-9">
      <input type="text" name="promotion_code" class="form promotion_code form-control" value="" id="promotion_code" />
                    ...
                    <form class="add-Queck-Payment modal-content pt-0 " autocomplete="off" id="form_model" method="post"  enctype="multipart/from-data" > 
                        ...
                        <div class="modal-body flex-grow-1">
                            <div class="row">
                              ...
                              <div class="form-group col-md-6 whatsappForm">
                                <label for="contact2">Phone (optional)</label>
                                <input type="text" class="form-control" name="phone_num" id="phone_num" placeholder="Type contact2 number here...." pattern="[7-9]{1}[0-9]{9}" required />
                                <div class="valid-feedback">Valid.</div>
                                <div class="invalid-feedback">Please enter valid contact no.</div>
                              </div> 
...
//----------------------------------------
const phoneInputField = document.querySelector("#merchantPhone");
const phoneInputField2 = document.querySelector("#org_phone");
