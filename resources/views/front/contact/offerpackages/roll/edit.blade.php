        ...
        <div class="card-body "> 
          ...
          <div class="table-responsive mt-2 mb-4 border-bottom">
            <table class="table">
                <thead>
                  <tr>
                    <th> <input class="form-check-input inp "id="select_col_1"  type="checkbox" /> MODULE</th>
                    <th><input class="form-check-input inp" id="select_col_9" type="checkbox" /> SUBMODULE</th>
...
@section('page-script')
  {{-- Page js files --}}
  <script src="{{ asset('js/scripts/pages/app-update-role.js') }}"></script> 
