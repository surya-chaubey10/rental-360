                      ...
                      <div class="row" >
                        <div class="col-md-12">
                          <div class="input-field">
                            ...
                            <span class="Image_error" id="Image_error" style="color:red"> </span>
                          </div>
                        </div>
                     </div>
                    <br>
                              ...
                              <div class="row">
                               ...
                               <div class=" col-md-6 col-sm-12 mb-2">
                                ...
                                <div class=" col-md-3 col-sm-6 mb-2">
                                  <label class="form-label" for="Number">Number Plate - Code</label>
                                ...
                                <div class=" col-md-3 col-sm-6 mb-2">
                                  <label class="form-label" for="Number">Number Plate - Number</label>
