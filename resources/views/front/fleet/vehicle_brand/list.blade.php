...
@section('content') 
<section class="vehicle-brand-list"> 
  <!-- list and filter start -->
  <div class="card"> 
      <div class="card-body border-bottom">
        <div class="card-header"> 
          <h4 ><b>Vehicle Brand</b></h4>
          <a href="{{route('add-vehicle-brand')}}" class="btn btn-danger" >Add New</a> 
      </div>
      </div>
    <div class="card-datatable table-responsive pt-0">
      <table class="vehicle-brand-table table">
