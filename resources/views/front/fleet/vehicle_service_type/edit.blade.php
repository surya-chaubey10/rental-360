  ...
  <div class="row"> 
      <div class="card">  
              <div class="card-body border-bottom">
               <form class="update-vehicle-service_type modal-content pt-0 form-block" autocomplete="off" id="updatevehicleservice_typee" method="post" enctype="multipart/from-data" > 
                <div class="card-header">
                  <h4 >Update Vehicle Service Type</h4>
              ...
              <div class="card-body">
                <section id="multiple-column-form"> 
                  <div class="row">
                    ...
                    <div class="col-md-12 col-12">
                      <div class="mb-1">
                        <label class="form-label" for="description-column">Service Type Description</label>
                        <div class="mb-1">
                          <textarea
                            class="form-control"
                            id="description"
...
@section('page-script')
  {{-- Page js files --}}
 <script src="{{ asset('js/scripts/pages/vehicle-service_type-update.js') }}"></script>  
