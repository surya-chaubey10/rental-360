  ...
  <div class="row"> 
      <div class="card">  
              <div class="card-body border-bottom">
               <form class="update-vehicle-type modal-content pt-0 form-block" autocomplete="off" id="updatevehicletypee" method="post" enctype="multipart/from-data" > 
...
@section('page-script')
  {{-- Page js files --}}
 <script src="{{ asset('js/scripts/pages/vehicle-type-update.js') }}"></script>  
