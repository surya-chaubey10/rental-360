              ...
              <div class="card-body border-bottom"> 
               <form class=" pt-0 form-block form-block" autocomplete="off" id="" >  
                <div class="card-header">
                  <h3><b>Create General Coupons</b></h3>                
                 ...
                 <section id="multiple-column-form">        
                  <div class="row">
					...
					<div class="col-md-6 col-6">      
                      <div class="mb-2">
                        <label class="form-label" for="products-name-column"><b>Cupons Code*</b> </label>      
                         <input
                          type="text"
                          id=""
                          class="form-control"
                    ...
                    <div class="col-md-6 col-6">
                      <div class="mb-2">
                        <label class="form-label" for="name-column"><b>Partness*</b> </label>      
                    ...
                    <div class="col-md-6 col-6">     
                      <div class="mb-2"> 
                        <label for="startDate"><b>End Time</b></label> 
                        <input    id="startDate" class="form-control" type="time" />      
                      </div>
                    </div>  
                 ...
                 <div class="col-md-6 col-6">      
                      <div class="mb-2">
                        <label class="form-label" for="products-name-column"><b>Percentage Amount*</b> </label>     
                         <input
                          type="text"
                          id=""
                          class="form-control"
                  ...
                  <div class="col-md-6 col-6">      
                      <div class="mb-2">
                        <label class="form-label" for="products-name-column"><b>Fixed Price*</b> </label>     
                         <input
                          type="text"
                          id=""
                          class="form-control"
					...
					<div class="col-md-6 col-6">     
                      <div class="mb-2">
                        <label class="form-label" for="products-name-column"><b>Booking Limit*</b> </label>     
                         <input
                          type="text"
                          id=""
                          class="form-control"
