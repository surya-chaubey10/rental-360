  ...
  <div class="row"> 
      <div class="card">  
              <div class="card-body border-bottom">
               <form class="update-offer-category modal-content pt-0 form-block form-block" autocomplete="off" id="updateoffercategory" method="post"> 
...
@section('page-script')
  {{-- Page js files --}}
 <script src="{{ asset('js/scripts/pages/update-offer-category.js') }}"></script>  
