              ...
              <div class="card-body border-bottom"> 
               <form class=" pt-0 form-block form-block" autocomplete="off" id="" >  
                <div class="card-header">
                  <h3><b>Edit Employee Payroll</b></h3>            
                  <button  id="" name="" type="submit" class="btn btn-danger me-1 ">Edit</button>     
                </div>  
              </div>  
              ...
              <div class="card-body">
                <section id="multiple-column-form">       
                  ...
                  <div class="col-md-4 col-4">  
                      <div class="mb-2">
                        <label class="form-label" for="name-column"><b>Present Salary</b> </label>    
                         <input
                          type="text"
                          id=""
                          class="form-control"
                    ...
                    <div class="col-md-4 col-4">  
                      <div class="mb-2">
                        <label class="form-label" for="name-column"><b>Deduction Amount </b> </label>     
                         <input
                          type="text"
                          id=""
                          class="form-control"
                   ...
                   <div class="col-md-4 col-4">  
                      <div class="mb-2">
                        <label class="form-label" for="name-column"><b>Deduction Reason</b> </label>        
                         <input
                          type="text"
                          id=""
                          class="form-control"
					 ...
					 <div class="col-md-4 col-4">   
                      <div class="mb-2"> 
                        <label for="startDate"><b>Salary Date</b></label> 
                         <input value="09/03/2019" id="startDate" class="form-control" type="date" />    
                      </div>
                    </div> 
