...
<div class="card-category-1">
    <div class="basic-card basic-card-aqua">
        ...
        <div class="card-content">
            <div>
                <span class="card-title">{{$document->ot_document1}}</span> <a href="{{Route('docs')}}"><i class="fa fa-pencil"></i></a>
                <a href='{{asset('/company/docs/'. $document->ot_document1)}}' download=""><i class="fa fa-eye"></i></a>
                <hr>
            ...
            <div>
                ...
                <img class="doc_image" style="height:150px; width:355px;" src='{{asset('/company/docs/'. $document->ot_document1)}}' alt="{{$document->ot_document1}}">
    ...
    <div class="basic-card basic-card-aqua">
        ...
        <div class="card-content">
            <div>
                <span class="card-title">{{$document->ot_document2}}</span> <a href="{{Route('docs')}}"><i class="fa fa-pencil"></i></a>
                <a href='{{asset('/company/docs/'. $document->ot_document2)}}' download=""><i class="fa fa-eye"></i></a>
                <hr>
            ...
            <div>
                <img class="doc_image" style="height:150px; width:355px;" src='{{asset('/company/docs/'. $document->ot_document2)}}' alt="{{$document->ot_document2}}">
            </div>
        </div>
    </div>
    @endforeach
    ...
    <div class="basic-card basic-card-aqua">
        ...
        <div class="card-content">
            <div>
                <span class="card-title">{{$document->ot_document3}}</span> <a href="{{Route('docs')}}"><i class="fa fa-pencil"></i></a>
                <a href='{{asset('/company/docs/'. $document->ot_document3)}}' download=""><i class="fa fa-eye"></i></a>
                <hr>
                <p class="card-text">Uploaded on : </p>
                <hr>
                <p>Status: </p>
            ...
            <div>
                <img class="doc_image" style="height:150px; width:355px;" src='{{asset('/company/docs/'. $document->ot_document3)}}' alt="{{$document->ot_document3}}">
            </div>
        </div>
    </div>
    @endforeach
    ...
    <div class="basic-card basic-card-aqua">
        ...
        <div class="card-content">
            <div>
                <span class="card-title">{{$document->ot_document4}}</span> <a href="{{Route('docs')}}"><i class="fa fa-pencil"></i></a>
                <a href='{{asset('/company/docs/'. $document->ot_document4)}}' download=""><i class="fa fa-eye"></i></a>
                <hr>
                <p class="card-text">Uploaded on : </p>
                <hr>
                <p>Status: </p>
            ...
            <div>
                <img class="doc_image" style="height:150px; width:355px;" src='{{asset('/company/docs/'. $document->ot_document4)}}' alt="{{$document->ot_document4}}">
            </div>
        </div>
    </div>
    @endforeach
