      ...
      <div class="card">  
              ...
              <div class="card-body">
                <section id="multiple-column-form">   
                  ...
                  <div class="col-md-6 col-6">
                      <div class="mb-2">
                        <label class="form-label" for="po-name-column"><b>Reference*</b></label>    
                        <input
                          type="text"
                          id=""
                          class="form-control"
					 ...
					 <div class="col-md-4 col-4">  
                      <div class="mb-2">
                        <label class="form-label" for="products-name-column"><b>Discount Type*</b> </label>    
                       <select class="form-select"   id=""   value="" name="" aria-label="Default select example">
					   <option value="volvo">Volvo</option>
                      <option value="saab">Saab</option>
                      <option value="vw">VW</option>
					 ...
					 <div class="col-md-4 col-4">  
                      <div class="mb-2">
                        <label class="form-label" for="products-name-column"><b>Discount</b> </label>   
                         <input
                          type="number"
                          id=""
                          class="form-control"
					 ...
					 <div class="col-md-4 col-4">    
                      <div class="mb-2">
                        <label class="form-label" for="products-name-column"><b>Transport Cost</b> </label>   
                        <input
                          type="number"
                          id=""
                          class="form-control"
					...
					<div class="col-md-4 col-4">  
                      <div class="mb-2">
                        <label class="form-label" for="products-name-column"><b>Invoice Tax*</b> </label>     
                       <select class="form-select"   id=""   value="" name="" aria-label="Default select example">
					   <option value="volvo">Volvo</option>
                      <option value="saab">Saab</option>
                      <option value="vw">VW</option>
                  ...
                  <div class="col-md-4 col-4">
                      <div class="mb-2">
                        <label class="form-label" for="po-name-column"><b>Total Tax</b></label>     
                        <input
                          type="text"
                          id=""
                          class="form-control"
					 ...
					 <div class="col-md-4 col-4">
                      <div class="mb-2">
                        <label class="form-label" for="po-name-column"><b>Net Total</b></label>    
                        <input
                          type="text"
                          id=""
                          class="form-control"
					...
					<div class="col-md-4 col-4">
                      <div class="mb-2">
                        <label class="form-label" for="po-name-column"><b>PO Reference*</b></label>    
                        <input
                          type="text"
                          id=""
                          class="form-control"
					...
					<div class="col-md-4 col-4">
                      <div class="mb-2">
                        <label class="form-label" for="po-name-column"><b>Payment Term*</b></label>     
                        <input
                          type="text"
                          id=""
                          class="form-control"
				...
				<div class="col-md-4 col-4">
                      <div class="mb-2">
                        <label class="form-label" for="products-name-column"><b>Add Payment?</b> </label>    
                       <select class="form-select"   id=""   value="" name="" aria-label="Default select example">
					   <option value="volvo">Volvo</option>
                      <option value="saab">Saab</option>
                      <option value="vw">VW</option>
					 ...
					 <div class="col-md-4 col-4">
                      <div class="mb-2">
                        <label class="form-label" for="po-name-column"><b>Delivery Place</b></label>    
                        <input
                          type="text"
                          id=""
                          class="form-control"
